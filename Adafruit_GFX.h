...
public:
  ...
  */
  ...
  // 实验6新增
  void showBootScreen(void);          // 开机画面
  void drawPentagram(int16_t x0, int16_t y0, int16_t r, uint16_t color);
  void drawStar6(int16_t x0, int16_t y0, int16_t rOuter, int16_t rInner, uint16_t color);
  void drawHeart(int16_t x0, int16_t y0, int16_t size, uint16_t color);
  void drawSpiral(int16_t cx, int16_t cy, int16_t rMax, uint8_t turns, uint16_t color);//实验新增到此为止
